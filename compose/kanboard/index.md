...
Este stack levanta una instancia funcional de Kanboard utilizando su configuración predeterminada con base de datos embebida (**SQLite**), asegurando la **persistencia de datos, plugins instalados y certificados SSL**.
...
> **Importante:** Por motivos de seguridad, es fundamental cambiar la contraseña del usuario `admin` inmediatamente tras el primer inicio de sesión desde el apartado de configuración de usuario.
